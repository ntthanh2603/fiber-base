  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props} >
          ...
          <form>
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button variant="outline" className="w-full" style={{backgroundColor: '#D0E3FF'}}>
              ...
              <div className="grid gap-6">
                ...
                <Button type="submit" className="w-full" style={{backgroundColor: '#D0E3FF'}}>
                  Đăng nhập
                </Button>
              </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-primary  ">
        Bằng cách nhấn đăng nhập, bạn đồng ý với chúng tôi  <a href="#">Điều khoản dịch vụ</a>{" "}
